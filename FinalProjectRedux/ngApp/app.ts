namespace MyApp {
    ...
    angular.module('MyApp', ['ngRoute', 'ngResource', 'angular-filepicker']).config(($routeProvider: ng.route.IRouteProvider, $locationProvider: ng.ILocationProvider, filepickerProvider) => {
